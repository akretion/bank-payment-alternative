...
by default some currencies.

In the payment order, when we choose a payment method line, it will have
in the payment order the default currencies but it's possible to add
some others.
